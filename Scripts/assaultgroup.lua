...
local target = "Tattoo" -- leave as scripter if spawning on yourself, otherwise use "targetname" 
local maxMonsters = 5; -- Please make sure that maximum possible... 
local maxCruisers = 5; --...number of ships does not exceed 10... 
local maxDreads = 5; --...otherwise the server may go gaga. 
...
function miForce() 
local factionID2 = getOwner("Exathra"); 

for e=1, randomNumber(0, maxMonsters) do 
local ship1 = "EGD Omicron "..e; --"Mind-Chained Gaifen"
local newShip = spawnShip(ships[220].path, target, ship1, factionID2 ); 
for f=1,2 do 
spawnNoun( "Gadgets\\Auto Repair.prt", newShip, "DCS"..f, newShip); 
spawnNoun( "Gadgets\\Railgun.prt", newShip, "Mass Driver"..f, newShip); 
spawnNoun( "Gadgets\\Gauss Gun.prt", newShip, "MagBore Gun"..f, newShip); 
spawnNoun( "Gadgets\\Drive - IE.prt", newShip, "Sublight Thruster"..f, newShip); 
end 
for f=1,2 do
spawnNoun( "Gadgets\\AR Missile.prt", newShip, "Hawk Wing Missile"..f, newShip); 
spawnNoun( "Gadgets\\IT Missile.prt", newShip, "Line Drive Missile "..f, newShip); 
spawnNoun( "Gadgets\\reactor aux.prt", newShip, "Fusion Core"..f, newShip); 
end
sendChat(scripter, 4, teal..ship1.." spawned at "..target..ec ); 
end 
for e=1, randomNumber(0, maxCruisers) do 
local ship2 = "FGD Epsilon "..e; 
local newShip = spawnShip(ships[231].path, target, ship2, factionID2 ); 
for f=1,4 do 
spawnNoun( "Gadgets\\Auto Repair.prt", newShip, "DCS"..f, newShip); 
spawnNoun( "Gadgets\\Railgun.prt", newShip, "Mass Driver"..f, newShip); 
spawnNoun( "Gadgets\\Gauss Gun.prt", newShip, "MagBore Gun"..f, newShip); 
...
for f=1,3 do
spawnNoun( "Gadgets\\Sabot Rocket.prt", newShip, "Typhoon Rockets"..f, newShip); 
spawnNoun( "Gadgets\\P Cruise Missile.prt", newShip, "THUD Cruise Missile"..f, newShip); 
spawnNoun( "Gadgets\\reactor aux.prt", newShip, "Fusion Core"..f, newShip); 
end
...
local ship3 = "AGD Sigma "..e;
local newShip = spawnShip(ships[231].path, target, ship3, factionID2 ); 
for f=1,5 do 
spawnNoun( "Gadgets\\Auto Repair.prt", newShip, "DCS"..f, newShip); 
spawnNoun( "Gadgets\\Railgun.prt", newShip, "Mass Driver"..f, newShip); 
spawnNoun( "Gadgets\\Gauss Gun.prt", newShip, "MagBore Gun"..f, newShip); 
...
for f=1,3 do
spawnNoun( "Gadgets\\Elf Beam.prt", newShip, "Leach Beam"..f, newShip); 
spawnNoun( "Gadgets\\Flux Cannon.prt", newShip, "EMP Beam"..f, newShip); 
spawnNoun( "Gadgets\\AR Missile.prt", newShip, "Hawk Wing Missile"..f, newShip); 
spawnNoun( "Gadgets\\IT Missile.prt", newShip, "Line Drive Missile "..f, newShip); 
spawnNoun( "Gadgets\\reactor aux.prt", newShip, "Fusion Core"..f, newShip); 
end
