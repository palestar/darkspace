...
IF "%ACTION%"=="Build" SET MAKECMD="export BUILD_CONFIGURATION=%LINUX_CONFIG%; mkdir -p %LINUX_CONFIG%; make;"
IF "%ACTION%"=="Clean" SET MAKECMD="export BUILD_CONFIGURATION=%LINUX_CONFIG%; mkdir -p %LINUX_CONFIG%; make clean;"
SET SSH=ssh -p 2200
