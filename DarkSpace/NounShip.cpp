...
static Constant OUT_OF_COMBAT_TIME( "OUT_OF_COMBAT_TIME", TICKS_PER_SECOND * 10 ); // 10s base + 10s per ship level in the setOutOfCombat() function
...
{
	int nCombatTime = OUT_OF_COMBAT_TIME + (TICKS_PER_SECOND * (10 * gadgetLevel()));
